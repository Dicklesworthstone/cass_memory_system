...
export const BudgetConfigSchema = z.object({
  ...
  dailyLimit: z.number().default(1.0),
  monthlyLimit: z.number().default(20.0),
...
export const RemoteCassConfigSchema = z
  .object({
...
export const CassSearchHitSchema = z
  .object({
...
export const DegradedSummarySchema = z
  .object({
